...
import { Award, CheckCircle2, Sparkles, Trophy, ArrowRight } from "lucide-react";
          ...
          <div className="relative">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Tu as terminé le module <span className="text-foreground font-semibold">"{title}"</span>
              </p>
            </div>
        ...
        <CardContent className="space-y-6 relative">
          ...
          >
            <p className="text-foreground font-semibold text-lg">
              💪 Tu progresses à chaque module !
            </p>
            <p className="text-muted-foreground text-sm">
              Continue sur ta lancée pour débloquer tous les modules et devenir un expert
            </p>
          </div>
