          ...
          <CardContent className="pt-6 space-y-5">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input type="range" min={0} max={100000} step={50} value={salaire} onChange={(e) => setSalaire(Number(e.target.value))} className="w-full accent-primary" />
              </div>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                ...
                <input type="range" min={0} max={5000} step={50} value={autres} onChange={(e) => setAutres(Number(e.target.value))} className="w-full accent-primary" />
              </div>
            </div>
