...
const defaultEmployeeItems: SidebarMenuItem[] = [
  ...
  { id: "appointments", label: "Mes rendez-vous", icon: "Calendar", order: 9, visible: true, categoryId: "mon-espace" },
  { id: "webinars", label: "Mes webinaires", icon: "Video", order: 10, visible: true, categoryId: "mon-espace" },
  { id: "invitations", label: "Mes invitations", icon: "Users", order: 11, visible: true, categoryId: "mon-espace" },
  ...
  { id: "budget", label: "ZENITH by FinCare", icon: "PiggyBank", order: 17, visible: true, categoryId: "programme-fincare" },
